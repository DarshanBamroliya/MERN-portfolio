...
function HeroSec() {
  ...
  return (
    <div className='relative w-full h-dvh overflow-hidden'>
      ...
      <section className="absolute top-0 right-0 left-0 mt-10">
        {/* Background video */}
        ...
        <div className='flex flex-col items-center justify-center'>
          <div className='text-center w-full flex flex-col items-center absolute top-0'>
            ...
            <div className='mt-8 sm:mt-10 px-2'>
              <h1 className="font-open-sans font-[600] leading-[1] text-2xl sm:text-4xl md:text-7xl xl:text-[15vh]">We create Feelings.</h1>
            </div>
          </div>
          {/* Profile Image */}
          <Image
          ...
          <p className="text-base sm:text-lg md:text-xl pt-4 sm:pt-5 font-averia tracking-wider font-extrabold mt-1 sm:mt-2 mb-4 sm:mb-6">
